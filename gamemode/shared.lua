...
function GM:InitConVars()
	...
	elseif CLIENT then
		...
		GAMEMODE.ConVars.TeamDot = CreateClientConVar( "sh_teamdot", "1", true, false )
		GAMEMODE.ConVars.TeamOutline = CreateClientConVar( "sh_teamoutline", "1", true, false )
		GAMEMODE.ConVars.TeamOutlineESP = CreateClientConVar( "sh_teamoutline_esp", "1", true, false )
